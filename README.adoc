...
This repo provides tools and instructions for deploying and using Google Spark Operator on OpenShift.

== Custom Spark images

We will create custom Spark images that include S3 connector components, JMX exporter for monitoring... (link:https://github.com/bbenzikry/spark-eks[Credits])
